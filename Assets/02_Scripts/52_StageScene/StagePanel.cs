...
public class StagePanel : MonoBehaviour
{
		...
		[SerializeField] private GameObject clearedStage;
		[SerializeField] private GameObject lockedStage;
		[SerializeField] private GameObject defaultStage;
		...
		public void Start()
		{
				...
				{
						GameObject stageBtn = Instantiate(UpdateStageButton((int)stageWorld, i + 1, maxInt),transform);
		...
		public GameObject UpdateStageButton(int world, int level, int maxLevelPerWorld)
		{
